...
<root>
  ...
  ├── Editor
  │   ├── Lrss3.SimplePolygonMaker.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Lrss3.SimplePolygonMaker.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Lrss3.SimplePolygonMaker.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Lrss3.SimplePolygonMaker.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Lrss3.SimplePolygonMaker`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package Simple Polygon Maker Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Lrss3.SimplePolygonMaker.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Lrss3.SimplePolygonMaker.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Lrss3.SimplePolygonMaker.Editor.Tests.asmdef`

  `Tests/Runtime/Lrss3.SimplePolygonMaker.Tests.asmdef`
...
Use the `Documentations~/Simple Polygon Maker.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
